...
EXEC InsertPatientWithBasicDetails 'Zvonimir', 2, '19670419', 'Complaining', '3841312', '3841513', 'Luka', @patientID OUTPUT, @insertedDate OUTPUT
...
EXEC InsertAppointment @doctorID, @patientID, 'Doctor', '20170307', 'Exam', 1, @insertedID OUTPUT
EXEC GetAppointments @patientID

DECLARE @now DATETIME = GETDATE()
EXEC UpdateAppointment @insertedID, 'Dr. House', @now, 'Stuff', 0
EXEC GetAppointments @patientID
...
EXEC InsertPatientWithBasicDetails 'Vedran', 2, '19970419', 'Complaining', '3841312', '3841513', 'Miroslav', @insertedID OUTPUT, @insertedDate OUTPUT
