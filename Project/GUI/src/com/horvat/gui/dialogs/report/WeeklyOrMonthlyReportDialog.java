...
public class WeeklyOrMonthlyReportDialog extends VMDialog<WeeklyOrMonthlyReportViewModel> {
    private JPanel contentPane;
    private JButton buttonOK;
    private JLabel lblNumPatients;
    private JTable tblDoctorData;

    public WeeklyOrMonthlyReportDialog(Window owner, String title, int width, int height, WeeklyOrMonthlyReportViewModel viewModel) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tblDoctorData = new JTable();
        scrollPane1.setViewportView(tblDoctorData);
    }
